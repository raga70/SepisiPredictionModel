...
//             .ToList();
//
//         foreach(var row in tmpListWithAllRowsWhereSepsisIsNegative)
//         {
//            
...
//                 break;  
//                 Console.Write("\r{0}                                        ", "Processing Negative row: " + avgResultOfNegativePatients.Count + " of: " + tmpListWithAllRowsWhereSepsisIsNegative.Count);
//                 
//         };
//
